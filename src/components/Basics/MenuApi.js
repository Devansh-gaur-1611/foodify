const Menu = [
  ...
  },
  {
    ...
    price: "180₹",
    description:
      "Thali or Bhojanam is a round platter used to serve food in South Asia and Southeast Asia. Thali is also used to refer to an Indian-style meal made up of a selection of various dishes which are served on a platter.Thali is also used in south Asia for ceremonial purposes.",
  },
  {
    id: 7,
    ...
    price: "60₹",
    description:
      "Mithai (sweets) are the confectionery and desserts of the Indian subcontinent.Thousands of dedicated shops in India, Pakistan, Bangladesh, Nepal and Sri Lanka sell nothing but sweet ",
  },
  {
    id: 8,
